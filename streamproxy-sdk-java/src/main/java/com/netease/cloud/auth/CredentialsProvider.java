...
/**
 * Interface for providing credentials. Implementations are free to use any strategy for providing
 * credentials, such as simply providing static credentials that don't change, or more complicated
 * implementations, such as integrating with existing key management systems.
 */
public interface CredentialsProvider {

    /**
     * Returns Credentials which the caller can use to authorize an request. Each implementation of
     * CredentialsProvider can chose its own strategy for loading credentials. For example, an
     * implementation might load credentials from an existing key management system, or load new
